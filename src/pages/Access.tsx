        ...
        <section className="py-24 lg:py-32">
          <div className="container mx-auto px-6 lg:px-12">
            <div className="max-w-4xl mt-16">
              <h1 className="font-serif text-2xl sm:text-3xl lg:text-5xl xl:text-7xl text-foreground mb-8">
                Access
              </h1>
          ...
          <div className="container mx-auto px-6 lg:px-12">
            <div className="max-w-4xl space-y-6">
              ...
              <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
                ...
                who are invited to engage with Arvion arrive through established
                networks of trust and shared values. This ensures that every
                relationship begins with the foundation of mutual understanding
        ...
        <section className="py-14 lg:py-32">
          <div className="container mx-auto px-6 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 max-w-6xl">
              <div>
                <h2 className="font-serif text-xl sm:text-2xl lg:text-4xl text-foreground mb-6">
              ...
              <div className="flex items-center justify-center lg:justify-end">
                <div className="text-center">
                  <ShieldLogo className="w-20 h-24 mx-auto mb-5 glow-purple" />
        ...
        <section className="py-14 lg:py-32">
          <div className="container mx-auto px-6 lg:px-12">
            <div className="max-w-4xl">
              <h2 className="font-serif text-xl sm:text-2xl lg:text-3xl text-foreground mb-6">
