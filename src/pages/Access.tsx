    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="py-32 lg:py-32">
          <div className="container mx-auto px-6 lg:px-12">
            <div className="max-w-4xl mt-15">
              ...
              <p className="text-body-lg text-muted-foreground leading-relaxed animate-fade-in opacity-0 animate-delay-200">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 max-w-6xl">
              <div>
                ...
                <div className="space-y-6">
                  <p className="space-y-6 text-muted-foreground">
        ...
        <section className="py-16 lg:py-32">
          <div className="container mx-auto px-6 lg:px-12">
            <div className="max-w-4xl">
              <h2 className="font-serif text-3xl lg:text-3xl text-foreground mb-8">
